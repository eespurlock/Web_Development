class Asteroid extends React.Component {
	...
	render() { 
		...
		const dangerous_ast = handleMapping(this.props.potentially_dangerous_asteroids);
		const non_dangerous_ast =  handleMapping(this.props.non_dangerous_asteroids);
	...
	handleRefresh = (e) =>{		 
		...
		fetch(picture_url).then((picture) => picture.json()).then((data) => {
		 ...
		 this.props.potentially_dangerous_asteroids = dangerous;
		 this.props.non_dangerous_asteroids = not_dangerous;
		 //this.setState({potentially_dangerous_asteroids: dangerous, non_dangerous_asteroids: not_dangerous})
		 console.log(this.props.potentially_dangerous_asteroids)
		 console.log(this.props.non_dangerous_asteroids)
	 }
